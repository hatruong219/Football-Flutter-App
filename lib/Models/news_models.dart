class News {
  ...
  News({required this.title,required this.subtitle, required this.content,required this.category,required this.time,required
      this.author,required this.seen,required this.favorite,required this.image,required this.estimate });
